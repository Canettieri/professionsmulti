...
local function GetTooltipText(self, id)
	local BonusTooltip = "\n"..L["craftsmanship"].."|r|cFFFFFFFF"..SKIM.." + |r|cFF69FF69"..SKIMIncrease.."|r|cFFFFFFFF "..L["bonus"].." =|r|cFF69FF69 "..(SKIM+SKIMIncrease) -- Bônus da profissão
	...
	local maxtext = "\n"..L["maxtext"]..TitanUtils_GetHighlightText(SKIMmax)
