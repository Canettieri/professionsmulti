...
local function GetTooltipText(self, id)
	local BonusTooltip = "\n"..L["craftsmanship"].."|r|cFFFFFFFF"..ALCM.." + |r|cFF69FF69"..ALCMIncrease.."|r|cFFFFFFFF "..L["bonus"].." =|r|cFF69FF69 "..(ALCM+ALCMIncrease) -- Bônus da profissão
	...
	local maxtext = "\n"..L["maxtext"]..TitanUtils_GetHighlightText(ALCMmax)
