...
local ID = "TITAN_RESHERBM_SL"

local reagentOneName = L["risingGlory"]
local reagentOneIcon = "|TInterface\\Icons\\inv_misc_herb_risingglory:0|t"
local reagentOneID = 168586
local reagentOne = 0
local startReagentOne = 0

local reagentTwoName = L["marrowroot"]
local reagentTwoIcon = "|T3480675:0|t"
local reagentTwoID = 168589
local reagentTwo = 0
local startReagentTwo = 0

local reagentThreeName = L["vigilsTorch"]
local reagentThreeIcon = "|T3387974:0|t"
local reagentThreeID = 170554
local reagentThree = 0
local startReagentThree = 0

local reagentFourName = L["widowbloom"]
local reagentFourIcon = "|TInterface\\Icons\\inv_misc_herb_bloodcup:0|t"
local reagentFourID = 168583
local reagentFour = 0
local startReagentFour = 0

local reagentFiveName = L["deathBlossom"]
local reagentFiveIcon = "|T3502461:0|t"
local reagentFiveID = 169701
local reagentFive = 0
local startReagentFive = 0

local reagentSixName = L["nightshade"]
local reagentSixIcon = "|T3692438:0|t"
local reagentSixID = 171315
local reagentSix = 0
...
L.Elib({
	id = ID,
	name = "Titan|cFFec7a38 "..L["herbalism"].."|r [|cFFEC7A37"..L["rShadowlands"].."|r] Multi",
