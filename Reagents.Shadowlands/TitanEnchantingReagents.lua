...
local ID = "TITAN_RESENCHM_SL"

local reagentOneName = L["soulDust"]
local reagentOneIcon = "|TInterface\\Icons\\inv_enchanting_dust:0|t"
local reagentOneID = 172230
local reagentOne = 0
local startReagentOne = 0

local reagentTwoName = L["sacredShard"]
local reagentTwoIcon = "|TInterface\\Icons\\inv_enchanting_shard:0|t"
local reagentTwoID = 172231
local reagentTwo = 0
local startReagentTwo = 0

local reagentThreeName = L["eternalCrystal"]
local reagentThreeIcon = "|TInterface\\Icons\\inv_enchanting_crystal:0|t"
local reagentThreeID = 172232
...
L.Elib({
	id = ID,
	name = "Titan|cFFec7a38 "..L["enchanting"].."|r [|cFFEC7A37"..L["rShadowlands"].."|r] Multi",
	tooltip = L["enchanting"].."|r [|cFFEC7A37"..L["rSL"].."|r]",
