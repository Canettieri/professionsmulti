--[[
Description: This plugin is part of the "Titan Panel [Professions] Multi" addon. It shows Alchemy Reagents.
...
local ID = "TITAN_RESALCYM_SL"

local reagentOneName = L["zinanthid"]
local reagentOneIcon = "|TInterface\\Icons\\inv_misc_herb_zoanthid:0|t"
local reagentOneID = 168487
local reagentOne = 0
local startReagentOne = 0

local reagentTwoName = L["riverbud"]
local reagentTwoIcon = "|TInterface\\Icons\\inv_misc_herb_riverbud:0|t"
local reagentTwoID = 152505
local reagentTwo = 0
local startReagentTwo = 0

local reagentThreeName = L["seastalk"]
local reagentThreeIcon = "|TInterface\\Icons\\inv_misc_herb_seastalk:0|t"
local reagentThreeID = 152511
local reagentThree = 0
local startReagentThree = 0

local reagentFourName = L["starmoss"]
local reagentFourIcon = "|TInterface\\Icons\\inv_misc_herb_starmoss:0|t"
local reagentFourID = 152506
local reagentFour = 0
local startReagentFour = 0

local reagentFiveName = L["akunda"]
local reagentFiveIcon = "|TInterface\\Icons\\inv_misc_herb_akundasbite:0|t"
local reagentFiveID = 152507
local reagentFive = 0
local startReagentFive = 0

local reagentSixName = L["wkiss"]
local reagentSixIcon = "|TInterface\\Icons\\inv_misc_herb_winterskiss:0|t"
local reagentSixID = 152508
local reagentSix = 0
...
local function GetTooltipText(self, id)
	...
	if reagentOne == 0 and reagentTwo == 0 and reagentThree == 0 and reagentFour == 0 and reagentFive == 0 and reagentSix == 0 and reagentSeven == 0 and reagentEight == 0 then
		...
		valueText = "\r"..L["info"]..reagentOneBag..reagentOneBank..reagentTwoBag..reagentTwoBank..reagentThreeBag..reagentThreeBank..reagentFourBag..reagentFourBank..reagentFiveBag..reagentFiveBank..reagentSixBag..reagentSixBank..reagentSevenBag..reagentSevenBank..reagentEightBag..reagentEightBank
	end
...
L.Elib({
	id = ID,
	name = "Titan|cFFec7a38 "..L["alchemy"].."|r [|cFFEC7A37"..L["rShadowlands"].."|r] Multi",
	tooltip = L["herbalism"].."|r [|cFFEC7A37"..L["rSL"].."|r]",
