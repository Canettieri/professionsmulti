...
local ID = "TITAN_RESFISHM_SL"

local reagentOneName = L["lostSole"]
local reagentOneIcon = "|TInterface\\Icons\\inv_fishing_lostsole:0|t"
local reagentOneID = 173032
local reagentOne = 0
local startReagentOne = 0

local reagentTwoName = L["silvergillPike"]
local reagentTwoIcon = "|TInterface\\Icons\\inv_fishing_silvergirllpike:0|t"
local reagentTwoID = 173034
local reagentTwo = 0
local startReagentTwo = 0

local reagentThreeName = L["pockedBonefish"]
local reagentThreeIcon = "|TInterface\\Icons\\inv_fishing_pockedbonefish:0|t"
local reagentThreeID = 173035
local reagentThree = 0
local startReagentThree = 0

local reagentFourName = L["iridescentAmberjack"]
local reagentFourIcon = "|TInterface\\Icons\\inv_fishing_iridescentamberjack:0|t"
local reagentFourID = 173033
local reagentFour = 0
local startReagentFour = 0

local reagentFiveName = L["spinefinPiranha"]
local reagentFiveIcon = "|TInterface\\Icons\\inv_fishing_spinefinpiranha:0|t"
local reagentFiveID = 173036
local reagentFive = 0
local startReagentFive = 0

local reagentSixName = L["elysianThade"]
local reagentSixIcon = "|TInterface\\Icons\\inv_fishing_elysianthade:0|t"
local reagentSixID = 173037
local reagentSix = 0
...
L.Elib({
	id = ID,
	name = "Titan|cFFec7a38 "..L["fishing"].."|r [|cFFEC7A37"..L["rShadowlands"].."|r] Multi",
	tooltip = L["fishing"].."|r [|cFFEC7A37"..L["rSL"].."|r]",
