...
local ID = "TITAN_RESTAILM_SL"

local reagentOneName = L["shroudedCloth"]
local reagentOneIcon = "|TInterface\\Icons\\inv_tailoring_commoncloth:0|t"
local reagentOneID = 173202
local reagentOne = 0
local startReagentOne = 0

local reagentTwoName = L["lightlessSilk"]
local reagentTwoIcon = "|TInterface\\Icons\\inv_tailoring_uncommoncloth:0|t"
local reagentTwoID = 173204
local reagentTwo = 0
local startReagentTwo = 0

local reagentThreeName = L["enLightlessSilk"]
local reagentThreeIcon = "|TInterface\\Icons\\inv_enchanting_craftedreagent_cloth:0|t"
local reagentThreeID = 172439
local reagentThree = 0
local startReagentThree = 0

local reagentFourName = L["penumbraThread"]
local reagentFourIcon = "|TInterface\\Icons\\inv_tailoring_thread:0|t"
local reagentFourID = 177062
local reagentFour = 0
local startReagentFour = 0
--[[
local reagentFiveName =
local reagentFiveIcon =
local reagentFiveID =
local reagentFive = 0
local startReagentFive = 0

local reagentSixName =
local reagentSixIcon =
local reagentSixID =
local reagentSix = 0
local startReagentSix = 0

local reagentSevenName =
local reagentSevenIcon =
local reagentSevenID =
local reagentSeven = 0
local startReagentSeven = 0

local reagentEightName =
local reagentEightIcon =
local reagentEightID =
...
L.Elib({
	id = ID,
	name = "Titan|cFFec7a38 "..L["tailoring"].."|r [|cFFEC7A37"..L["rShadowlands"].."|r] Multi",
	tooltip = L["tailoring"].."|r [|cFFEC7A37"..L["rSL"].."|r]",
