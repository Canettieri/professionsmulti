--[[
Description: This plugin is part of the "Titan Panel [Professions] Multi" addon. It shows Jewelcrafting Reagents.
...
local ID = "TITAN_RESJEWCM_SL"

local reagentOneName = L["angerseye"]
local reagentOneIcon = "|TInterface\\Icons\\inv_jewelcrafting_90_gem_red:0|t"
local reagentOneID = 173109
local reagentOne = 0
local startReagentOne = 0

local reagentTwoName = L["oriblase"]
local reagentTwoIcon = "|TInterface\\Icons\\inv_jewelcrafting_90_gem_yellow:0|t"
local reagentTwoID = 173108
local reagentTwo = 0
local startReagentTwo = 0

local reagentThreeName = L["umbryl"]
local reagentThreeIcon = "|TInterface\\Icons\\inv_jewelcrafting_90_gem_blue:0|t"
local reagentThreeID = 173110
...
L.Elib({
	id = ID,
	name = "Titan|cFFec7a38 "..L["jewelcrafting"].."|r [|cFFEC7A37"..L["rShadowlands"].."|r] Multi",
	tooltip = L["jewelcrafting"].."|r [|cFFEC7A37"..L["rSL"].."|r]",
