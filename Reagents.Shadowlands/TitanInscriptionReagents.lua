--[[
Description: This plugin is part of the "Titan Panel [Professions] Multi" addon. It shows Inscription Reagents.
...
local ID = "TITAN_RESISCPM_SL"

local reagentOneName = L["luminousInk"]
local reagentOneIcon = "|TInterface\\Icons\\inv_inscription_ink_luminous01:0|t"
local reagentOneID = 173059
local reagentOne = 0
local startReagentOne = 0

local reagentTwoName = L["umbralInk"]
local reagentTwoIcon = "|TInterface\\Icons\\inv_inscription_ink_umbral01:0|t"
local reagentTwoID = 173058
local reagentTwo = 0
local startReagentTwo = 0

local reagentThreeName = L["tranquilInk"]
local reagentThreeIcon = "|TInterface\\Icons\\inv_inscription_ink_tranquil01:0|t"
local reagentThreeID = 175970
local reagentThree = 0
local startReagentThree = 0

local reagentFourName = L["luminousPigment"]
local reagentFourIcon = "|TInterface\\Icons\\inv_inscription_pigment_luminous01:0|t"
local reagentFourID = 173057
local reagentFour = 0
local startReagentFour = 0

local reagentFiveName = L["umbralPigment"]
local reagentFiveIcon = "|TInterface\\Icons\\inv_inscription_pigment_umbral01:0|t"
local reagentFiveID = 173056
local reagentFive = 0
local startReagentFive = 0

local reagentSixName = L["tranquilPigment"]
local reagentSixIcon = "|TInterface\\Icons\\inv_inscription_pigment_tranquil01:0|t"
local reagentSixID = 175788
local reagentSix = 0
local startReagentSix = 0

local reagentSevenName = L["ardenwood"]
local reagentSevenIcon = "|TInterface\\Icons\\inv_tradeskillitem_02:0|t"
local reagentSevenID = 175923
local reagentSeven = 0
local startReagentSeven = 0

local reagentEightName = L["darkParchment"]
local reagentEightIcon = "|TInterface\\Icons\\inv_inscription_parchmentvar02:0|t"
local reagentEightID = 175886
...
L.Elib({
	id = ID,
	name = "Titan|cFFec7a38 "..L["inscription"].."|r [|cFFEC7A37"..L["rShadowlands"].."|r] Multi",
	tooltip = L["inscription"].."|r [|cFFEC7A37"..L["rSL"].."|r]",
